...
public class JsChart extends Div implements org.zkoss.zssex.ui.widget.Chart {
	...
	static {
		...
		DEFAULT_MODEL.put(BUBBLE, "org.zkoss.zul.SimpleXYZModel"); // @since
		// 3.5.0
		DEFAULT_MODEL.put(WAFERMAP, "org.zkoss.zul.WaferMapModel"); // @since
		// 3.5.0
	...
	protected void renderProperties(ContentRenderer renderer)
		...
		renderer.render("chartModel", buildChartModel());
	}
	...
	protected int calculateTickInterval(int width, Map<String, Object> cm) {
		...
		return (labelCnt * 130 / width) <= 1 ? 1 : (labelCnt * 130 / width);
	}
	...
	/**
	 * Returns the legend font of this chart. If you saw squares rather than
	 * correct words in legend, check whether the default legend font supports
	 * your characters (e.g. Chinese). You probably have to set this font
	 * accordingly.
	 * 
	 * @return the title font
	...
	/**
	 * Sets the legend font of this chart. If you saw squares rather than
	 * correct words in legend, check whether the default legend font supports
	 * your characters (e.g. Chinese). You probably have to set this font
	 * accordingly.
	 * 
	 ...
	 * rather than correct words in x axis tick, check whether the default x
	 * axis tick font supports your characters (e.g. Chinese). You probably have
	 * to set this font accordingly.
	 * 
	...
	/**
	 * Returns the label font of x axis of this chart. If you saw squares rather
	 * than correct words in x axis label, check whether the default x axis
	 * label font supports your characters (e.g. Chinese). You probably have to
	 * set this font accordingly.
	 * 
	...
	/**
	 * Sets the label font of x axis of this chart. If you saw squares rather
	 * than correct words in x axis label, check whether the default x axis
	 * label font supports your characters (e.g. Chinese). You probably have to
	 * set this font accordingly.
	 * 
	 ...
	 * rather than correct words in y axis tick, check whether the default y
	 * axis tick font supports your characters (e.g. Chinese). You probably have
	 * to set this font accordingly.
	 * 
	...
	/**
	 * Returns the label font of y axis of this chart. If you saw squares rather
	 * than correct words in y axis label, check whether the default y axis
	 * label font supports your characters (e.g. Chinese). You probably have to
	 * set this font accordingly.
	 * 
	...
	/**
	 * Sets the label font of y axis of this chart. If you saw squares rather
	 * than correct words in y axis label, check whether the default y axis
	 * label font supports your characters (e.g. Chinese). You probably have to
	 * set this font accordingly.
	 * 
	...
	/**
	 * Instantiates the default chart engine. It is called, if
	 * {@link #setEngine} is not called with non-null engine.
	 * 
	 * <p>
	 * By default, it looks up the library property called
	 * org.zkoss.zul.chart.engine.class. If found, the value is assumed to be
	 * the class name of the chart engine (it must implement {@link ChartEngine}
	...
	protected ChartEngine newChartEngine() throws UiException {
		...
		if (!(v instanceof ChartEngine))
			throw new UiException(ChartEngine.class
	...
	public void setAreaListener(String clsnm) throws ClassNotFoundException,
			...
			InstantiationException, java.lang.reflect.InvocationTargetException {
		if (clsnm != null) {
			setAreaListener((ChartAreaListener) Classes
	...
	// Cloneable//
	public Object clone() {
		final JsChart clone = (JsChart) super.clone();
		...
		if (clone._model != null) {
			if (clone._model instanceof ComponentCloneListener) {
				final ChartModel model = (ChartModel) ((ComponentCloneListener) clone._model)
						.willClone(clone);
				if (model != null)
					clone._model = model;
			}
