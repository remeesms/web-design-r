...
public class PersistenceService implements XMLConstants {
	...
	public static final synchronized void setPersistenceDelegate(Class paramClass,
			PersistenceDelegate paramPersistenceDelegate) {
	...
	protected static synchronized void installPersistenceDelegates(Encoder paramEncoder) {
		...
		while (localIterator.hasNext()) {
			...
			paramEncoder.setPersistenceDelegate((Class) localEntry.getKey(),
					(PersistenceDelegate) localEntry.getValue());
		}
	}

	public static void store(Object paramObject, OutputStream paramOutputStream) throws NullPointerException,
	...
	public static void store(Object paramObject, File paramFile) throws NullPointerException,
			PersistenceServiceException {
		if (paramFile == null)
			throw new NullPointerException();
		File localFile = null;
		...
		try {
			...
			throw new PersistenceServiceException(localObject);
		}
	}
	...
	public static byte[] store2ByteArray(Object paramObject) throws PersistenceServiceException {
		try {
	...
	public static String store2String(Object paramObject) throws PersistenceServiceException {
		try {
			ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream();
			store(paramObject, localByteArrayOutputStream);
	...
	public static Object load(InputStream paramInputStream) throws NullPointerException, PersistenceServiceException {
		if (paramInputStream == null)
			throw new NullPointerException();
		XMLDecoder localXMLDecoder = null;
		try {
			localXMLDecoder = new XMLDecoder(new BufferedInputStream(paramInputStream, BUFSIZE), null,
			...
			if (localXMLDecoder != null) {
				try {
					...
					throw new PersistenceServiceException(localThrowable3);
				}
			}
			return null;
		}
	...
	public static Object load(File paramFile) throws NullPointerException, PersistenceServiceException {
		if (paramFile == null)
			throw new NullPointerException();
		try {
	...
	public static Object load(byte[] paramArrayOfByte) throws NullPointerException, PersistenceServiceException {
	...
	public static Object load(String paramString) throws NullPointerException, PersistenceServiceException {
		if (paramString == null)
			throw new NullPointerException();
		try {
